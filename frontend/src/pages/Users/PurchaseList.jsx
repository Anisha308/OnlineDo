      ...
      <div className="mt-7  text-gray-500 dark:text-gray-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-4 mt-5 min-h-[145px] w-full place-items-center overflow-x-scroll rounded-lg p-6 lg:overflow-visible">
          {purchases.map((purchase) => (
            <div
              key={purchase._id}
              className="flex w-960 max-w-[990px] rounded-xl bg-gradient-to-r from-white to-gray-200 bg-clip-border text-gray-700 shadow-md mb-5 border border-gray-300" // Added border and shadow classes
            >
              <div className="w-full md:w-1/3 flex ml-2 justify-center items-center">
              ...
              <div className="md:w-2/3 p-6 flex flex-col justify-between">
                <div>
                  ...
                  <div
                    className="block mb-2 font-sans text-base antialiased font-normal leading-relaxed text-gray-700"
                ...
                <div className="flex justify-between">
                  ...
                  >
                    <button
                      className="flex bg-blue-900 text-white items-center gap-2 px-6 py-4 font-sans text-xs font-bold text-center text-red-500 uppercase align-middle transition-all rounded-lg select-none hover:bg-blue-900/60 active:bg-pink-500/30 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                      type="button"
                    >
                      Start Learning
                      <svg
